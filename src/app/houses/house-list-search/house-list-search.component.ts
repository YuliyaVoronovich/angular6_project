...
@Component({
  selector: 'app-house-list-search',
  templateUrl: './house-list-search.component.html',
  styleUrls: ['./house-list-search.component.css']
})
export class HouseListSearchComponent implements OnInit {
