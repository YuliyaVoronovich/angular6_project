...
@Component({
  selector: 'app-houses-list-moderation',
  templateUrl: './houses-list-moderation.component.html',
  styleUrls: ['./houses-list-moderation.component.css']
})
export class HousesListModerationComponent implements OnInit, OnDestroy {
  ...
  getHouses() {
    ...
    return this.houseService.getHousesModeration(this.search).subscribe(data => {

      this.houseService.countHousesModeration(this.search).subscribe(data1 => {
