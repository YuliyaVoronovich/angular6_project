...
@Component({
  selector: 'app-sale-modificate-delete',
  templateUrl: './sale-modificate-delete.component.html',
  styleUrls: ['./sale-modificate-delete.component.css'],
  providers: [
    {provide: NgbDateParserFormatter, useClass: NgbDateFRParserFormatter}
  ]
})
export class SaleModificateDeleteComponent implements OnInit {
  ...
  return() {
    ...
    if (this.sale.id !== 0) {
      this.saleService.returnDelete(this.sale).subscribe(
        data => {
          if (data) {
  ...
  archive() {
    ...
    if (this.sale.id !== 0) {
      this.saleService.archiveDelete(this.sale).subscribe(
        data => {
          if (data) {
