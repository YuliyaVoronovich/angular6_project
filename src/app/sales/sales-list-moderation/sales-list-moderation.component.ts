...
@Component({
  selector: 'app-sales-list-moderation',
  templateUrl: './sales-list-moderation.component.html',
  styleUrls: ['./sales-list-moderation.component.css']
})
export class SalesListModerationComponent implements OnInit, OnDestroy {
  ...
  getSales() {
    ...
    return this.saleService.getSalesModeration(this.search).subscribe(data => {
      this.sales = [];
      this.saleService.countSalesModeration(this.search).subscribe(data1 => {
